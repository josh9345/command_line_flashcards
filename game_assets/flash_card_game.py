...
def create_card(Card):
    ...
    new_card = Card(front=question, back=answer, wrong=0)
    new_card.save()
...
def around_castle(game, card):
    print("Around the castle seems the safest, almost instantly you notice a man dead on the ground looks like a guard that fell over the wall, you take his spear and continue around the wall.\n")
    time.sleep(7)


def start_game(game, card, hydra_fail, around_castle):
    print("You wake up in a dark cave you don't know who you are or why you're here, luckily you still have your vast knowledge of trivia what luck!\n\n\n")
    time.sleep(5)
    ...
    if playing == 0:
        ...
        time.sleep(5)
        print(
            "You see a small castle in the distance....you start towards it to investigate")
        time.sleep(5)
        ...
        if playing == 0:
            ...
            if playing == 0:
                ...
                if playing == 0:
                    ...
                    time.sleep(8)
                    print("You see fear in his eyes he knows this is his end, your aim is true the sword pierces his heart, he staggers back and begins changing into the old man you saw before\n")
                    time.sleep(8)
                    print("he stands before you now withered and frail, shows a faint smile and collapses........\n Now you may rest but your journey isn't over yet.")
...
menu = input(
    "would you like to play the game or create some trivia cards of your own? enter 'game' or 'create' \n")
if menu == "game":
    random.shuffle(card)
    start_game(game, card, hydra_fail, around_castle)
else:
    create_card(Card)
    random.shuffle(card)
    menu
